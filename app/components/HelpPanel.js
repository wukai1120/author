...
Author 支持基于 CloudBase 云开发的多设备实时云同步，让你在不同设备上无缝切换创作。
...
### 桌面客户端 vs 自部署
| 特性 | 桌面客户端 | 自部署 (Docker/源码) |
|------|:---------:|:------------------:|
| 云同步 | ✓ 内置 | 需配置 CloudBase |
| 配置难度 | 无需配置 | 需创建 CloudBase 环境 |
| 数据归属 | 官方服务器 | 自建 CloudBase |

> 💡 桌面客户端已内置官方云同步服务器，无需额外配置，登录即用。
